...
export const getSeqTemplatesByKind = (kind: string) => seqApi(`/email/seq-templates?kind=${encodeURIComponent(kind)}`)
export const getQuoteTemplates = () => getSeqTemplatesByKind('quote')
export const deleteSeqTemplate = (id: string) => seqApi(`/email/seq-templates/${encodeURIComponent(id)}`, 'DELETE')
